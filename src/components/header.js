...
const Header = () => (
  <header className="container py-10" id="header" data-scroll-section>
    <div className="flex flex-wrap items-center">
      <div data-scroll data-scroll-speed="6" data-scroll-position="top" data-scroll-target="#header" data-scroll-direction="horizontal">
      ...
      <div className="flex-1">
        <div className="flex justify-end sm:justify-center md:mr-20">
          <div role="navigation" aria-label="Site Navigation">
            <nav data-scroll data-scroll-speed="-6" data-scroll-position="top" data-scroll-target="#header" data-scroll-direction="horizontal">
